...
PANEL_GENERATOR_VERSION = "adp-management-panel-contract/1.0.0"
...
def compose_panel(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    input_audit_ids = sorted({status["input_audit_id"], packs["fde-morning"]["input_audit_id"], packs["business-biweekly"]["input_audit_id"]})
    ...
    manifest = {
        ...
        "as_of": status["as_of"],
        "reporting_period": copy.deepcopy(status["reporting_period"]),
